...
for y in range(1, 551, 100):
    ...
    for x in range(0, 599, 100):
        ...
        sd.line(start_point=start_point_2, end_point=end_point_2, color=current_color_two, width=1)
        start_point_21 = sd.get_point(x + 1, y + 1)
        end_point_21 = sd.get_point(x + 1, y + 49)
        sd.line(start_point=start_point_21, end_point=end_point_21, color=current_color_two, width=1)
        start_point_22 = sd.get_point(x - 1, y + 1)
        end_point_22 = sd.get_point(x - 1, y + 49)
        sd.line(start_point=start_point_22, end_point=end_point_22, color=current_color_two, width=1)
        start_point_23 = sd.get_point(x + 2, y + 1)
        end_point_23 = sd.get_point(x + 98, y + 1)
        sd.line(start_point=start_point_23, end_point=end_point_23, color=current_color_two, width=1)
        start_point_24 = sd.get_point(x + 2, y + 49)
        end_point_24 = sd.get_point(x + 98, y + 49)
        sd.line(start_point=start_point_24, end_point=end_point_24, color=current_color_two, width=1)
